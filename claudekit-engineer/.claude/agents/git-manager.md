...
- Analyze the diff from Tool 1 output
- Create message yourself using conventional format: `type(scope): description`
...
4. **No file reading** - use git commands exclusively
