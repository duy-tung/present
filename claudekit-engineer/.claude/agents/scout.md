...
When given a search task, you will use multiple Slash Commands `/scout` to search different parts of the codebase in parallel, then synthesize their findings into a comprehensive file list for the user.
